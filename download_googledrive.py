...
def main():
    ...
    SPREADSHEET_ID = '1VyDTgX_gaER8WWDx7yz9bfKT6QddSvQIOFUt9RYF-q8'
    RANGE_NAME = "'Social Factors Codings'!A2:AP1311"
    HEADER_RANGE = "'Social Factors Codings'!A1:AP"
    ...
    songs_df.to_csv('raw/sources.csv', index=False)
    print("successful")
