...
1. Clone the repository to your local machine. This can be done by copying the url from the green code box on this page and tpying `git clone <url>` into the terminal
